                    ...
                    <div className="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={5}
                                className="w-full rounded-lg border border-default bg-surface-0 px-3 py-2.5 text-sm text-surface-900 placeholder:text-surface-400 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none resize-none"
                            />
