...
export function FloatingTimer() {
    ...
    return (
        <div className="fixed bottom-20 right-4 left-4 z-40 bg-white dark:bg-surface-900 rounded-2xl shadow-2xl border border-surface-200 dark:border-surface-700 p-4">
            ...
            <div className="text-center mb-3">
                <p className={cn(
                    ...
                    isRunning ? 'text-surface-900 dark:text-surface-50' : 'text-surface-400'
                )}>
