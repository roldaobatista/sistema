                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {(filtered as CrmMessageTemplate[]).map(t => {
                        ...
                        return (
                            <div
                                key={t.id}
                                className="group rounded-xl border border-surface-200 bg-white p-5 shadow-card hover:shadow-elevated transition-all"
                            >
                                {/* Header */}
                    ...
                    <div className="p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-surface-200 bg-white px-3 py-2 text-sm text-surface-900 font-mono placeholder:text-surface-400 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={6}
                                className="w-full rounded-lg border border-surface-200 bg-white px-3 py-2.5 text-sm text-surface-900 placeholder:text-surface-400 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none resize-none font-mono"
                            />
                        </div>
                    </div>
