...
export function ProductsPage() {
    ...
    return (
        <div className="space-y-5 animate-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-bold text-surface-900 tracking-tight">Produtos</h1>
                    <p className="mt-0.5 text-sm text-surface-500">Catálogo de produtos e peças</p>
                </div>
            ...
            <div className="overflow-hidden rounded-xl border border-default bg-surface-0 shadow-card">
                <table className="w-full">
                    ...
                    <tbody className="divide-y divide-subtle">
                        {products.length === 0 ? (
                            <tr><td colSpan={5} className="px-4 py-12 text-center text-[13px] text-surface-500">Nenhum produto encontrado</td></tr>
                        ) : products.map(p => (
