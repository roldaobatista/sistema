            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
                        ...
                        <>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 py-2.5 rounded-lg bg-surface-100 border-0 text-sm placeholder:text-surface-400 focus:ring-2 focus:ring-brand-500/30 focus:outline-none"
                                />
                ...
                <div className="bg-card rounded-xl p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <label className="aspect-square flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-surface-300 cursor-pointer active:bg-surface-50">
