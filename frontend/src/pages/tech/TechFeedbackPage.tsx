                    ...
                    <div className="space-y-4">
                                ...
                                {TYPE_OPTIONS.map((opt) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            type === opt.id && opt.color === 'emerald' && 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30',
                                            type === opt.id && opt.color === 'blue' && 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400',
                                            type === opt.id && opt.color === 'amber' && 'bg-amber-100 text-amber-700 dark:bg-amber-900/30',
                                            type === opt.id && opt.color === 'red' && 'bg-red-100 text-red-700 dark:bg-red-900/30',
                                            type !== opt.id && 'bg-surface-100 text-surface-600 dark:text-surface-400'
                                        )}
                                    >
                                        {opt.label}
                                    </button>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            category === cat
                                                ...
                                                : 'bg-surface-100 text-surface-600 dark:text-surface-400'
                                        )}
                                    >
                                        {cat}
                                    </button>
                        ...
                        <div className="bg-card rounded-xl p-4 space-y-3">
                            ...
                            <label className="block">
                                ...
                                />
                                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-100 text-sm font-medium text-surface-700 cursor-pointer">
                    ...
                    <div className="space-y-3">
                        {loadingHistory ? (
                            ...
                            history.map((item) => {
                                    ...
                                    return (
                                        <div key={item.id} className="bg-card rounded-xl p-4 space-y-2">
                                            <div className="flex items-center gap-2 flex-wrap">
                                                ...
                                                <span className={cn(
                                                    ...
                                                    status === 'sent' && 'bg-surface-100 text-surface-600'
                                                )}>
                                            ...
                                            {(item as any).manager_reply && (
                                                <div className="mt-2 p-3 rounded-lg bg-brand-50 border-l-2 border-brand-500">
                                                    ...
                                                    <p className="text-sm text-surface-700 mt-1">{(item as any).manager_reply}</p>
                                                </div>
                                            )}
                                        </div>
                                    )
