                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {SEVERITY_OPTIONS.map((opt) => (
                                <button
                                    ...
                                    className={cn(
                                        'px-3 py-1.5 rounded-lg text-xs font-medium transition-colors',
                                        severity === opt.value ? cn(opt.className, 'ring-2 ring-brand-500 ring-offset-2 dark:ring-offset-surface-900') : 'bg-surface-100 text-surface-600'
                                    )}
                                >
                                    {opt.label}
                                </button>
                    ...
                    <div>
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-surface-100 text-surface-700 text-sm font-medium"
                        >
