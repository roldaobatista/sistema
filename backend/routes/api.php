...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'check.tenant'])->group(function () {
        ...
        Route::middleware('check.permission:commissions.rule.view')->group(function () {
            ...
            Route::post('commission-disputes/{dispute}/resolve', [\App\Http\Controllers\Api\V1\Financial\CommissionDisputeController::class, 'resolve']);
        });
        // Metas de Vendas
        Route::middleware('check.permission:commissions.rule.view')->group(function () {
            ...
            Route::put('commission-goals/{goal}', [\App\Http\Controllers\Api\V1\Financial\CommissionGoalController::class, 'update']);
            ...
            Route::delete('commission-goals/{goal}', [\App\Http\Controllers\Api\V1\Financial\CommissionGoalController::class, 'destroy']);
        });
        ...
        Route::middleware('check.permission:commissions.rule.view')->group(function () {
            ...
            Route::post('commission-campaigns', [\App\Http\Controllers\Api\V1\Financial\CommissionCampaignController::class, 'store']);
            Route::put('commission-campaigns/{campaign}', [\App\Http\Controllers\Api\V1\Financial\CommissionCampaignController::class, 'update']);
            Route::delete('commission-campaigns/{campaign}', [\App\Http\Controllers\Api\V1\Financial\CommissionCampaignController::class, 'destroy']);
        });
        ...
        Route::middleware('check.permission:commissions.rule.view')->group(function () {
            ...
            Route::put('recurring-commissions/{id}/status', [\App\Http\Controllers\Api\V1\Financial\RecurringCommissionController::class, 'updateStatus']);
            ...
            Route::delete('recurring-commissions/{id}', [\App\Http\Controllers\Api\V1\Financial\RecurringCommissionController::class, 'destroy']);
        });
        ...
        // Categorias de Contas a Pagar (editÃ¡veis)
        ...
        // Perfil do UsuÃ¡rio (com permissÃµes/roles expandidos)
        // FIX-B1: Usar FQCN para Api\V1\UserController (nÃ£o confundir com Iam\UserController importado no topo)
        ...
        // â”€â”€â”€ Perfil do UsuÃ¡rio â”€â”€â”€
        // FIX-B5: Usar o controller de perfil (Api\V1\UserController), nÃ£o o IAM
        Route::post('profile/change-password', [\App\Http\Controllers\Api\V1\UserController::class, 'changePassword']);

        // RelatÃ³rios adicionais (suppliers, stock)
        ...
        // â”€â”€â”€ OperaÃ§Ãµes (Fase 5) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Route::middleware('check.permission:os.work_order.view')->group(function () {
        ...
        // â”€â”€â”€ Agendamento TÃ©cnico (Fase 5.4) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Route::middleware('check.permission:technicians.schedule.view')->group(function () {
        ...
        Route::prefix('sla-dashboard')->group(function () {
        ...
        Route::get('cash-flow/dre-comparativo', [\App\Http\Controllers\Api\V1\CashFlowController::class, 'dreComparativo']);
        ...
        Route::prefix('central')->group(function () {
            ...
            Route::post('items', [\App\Http\Controllers\Api\V1\CentralController::class, 'store']);
            Route::get('items/{centralItem}', [\App\Http\Controllers\Api\V1\CentralController::class, 'show']);
            Route::patch('items/{centralItem}', [\App\Http\Controllers\Api\V1\CentralController::class, 'update']);
            Route::post('items/{centralItem}/assign', [\App\Http\Controllers\Api\V1\CentralController::class, 'assign']);
...
// â”€â”€â”€ Webhooks (verificaÃ§Ã£o por assinatura) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Rotas pÃºblicas (sem autenticaÃ§Ã£o, com token) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
