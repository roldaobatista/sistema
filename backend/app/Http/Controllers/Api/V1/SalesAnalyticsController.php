...
class SalesAnalyticsController extends Controller
{
    ...
    /**
     * GET /sales/quote-rentability/{quote}
     * Calculates profit margin for a quote considering costs and suggested discounts.
     */
    ...
    /**
     * GET /sales/follow-up-queue
     * Quotes that need follow-up (pending + overdue).
     */
    ...
    /**
     * GET /sales/loss-reasons
     * Analysis of lost deals by reason.
     */
    ...
    /**
     * GET /sales/client-segmentation
     * ABC client segmentation by revenue (Pareto).
     */
    ...
    /**
     * GET /sales/upsell-suggestions/{customer}
     * Suggests products/services the customer hasn't purchased but similar clients have.
     */
    public function upsellSuggestions(Customer $customer): JsonResponse
    {
        $tenantId = $this->tenantId();

        // Services purchased by this customer
        ...
        // Services popular among all customers but NOT purchased by this one
    ...
    /**
     * GET /sales/discount-requests
     * Lists quotes with discount pending admin approval.
     */
